...
export const packages = [
  ...
  },
  {
    ...
    features: [
      "Alles aus Starter",
      "Lokale Auffindbarkeit für Leistungen und Städte",
      "Sie sehen, woher Anfragen kommen",
      "Telefon, WhatsApp und Formulare getrennt sichtbar",
      "Übersichtliche Auswertung der Kontaktwege",
    ],
    cta: "Kostenlose Erstanalyse",
  ...
  },
  {
    ...
    features: [
      ...
      "Alle Anfragen in einer Übersicht",
