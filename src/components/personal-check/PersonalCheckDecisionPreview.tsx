...
const deeperCheckItems = [
  "3–5 priorisierte Hinweise entlang Ihres Anfragewegs",
  "Eine klare Reihenfolge statt einer langen Maßnahmenliste",
  "Einen realistischen ersten Test ohne unnötigen Umbau",
];
        ...
        <header className="border-b border-border bg-background/95 text-foreground backdrop-blur-xl">
          <div className="container-lp flex h-[72px] items-center justify-between gap-4">
            ...
            >
              ...
              <span className="hidden sm:inline">Über IXA</span>
              <span className="sm:hidden">IXA</span>
            </Link>
          </div>
        </header>
            ...
            <div className="relative grid gap-9 lg:grid-cols-[1fr_.82fr] lg:items-center">
              ...
              <div className="rounded-3xl border border-white/15 bg-white/5 p-5 backdrop-blur sm:p-6">
                <button
                  type="button"
                  disabled
                  aria-describedby="decision-preview-note"
                ...
                <p className="mt-3 text-center text-sm font-semibold text-white/75">
                  Unverbindlich · zunächst ohne Termin
                </p>
                ...
                >
                  ...
                  Lieber direkt sprechen? 15-Minuten-Gespräch anfragen
                </button>
