        ...
        <div className="container-lp grid items-center gap-10 lg:grid-cols-[1.15fr_.85fr]">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-stone-600 sm:text-xl">
              ...
              vorbereitet. Keine allgemeine Werbepräsentation, sondern konkrete
              Ansatzpunkte, die wir Ihnen persönlich zeigen.
            </p>
      ...
      <section className="container-lp py-12 sm:py-16">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-stone-600 sm:text-lg">
            Eine kurze Antwort genügt. Danach erhalten Sie den Check persönlich,
            ohne automatische Terminbuchung und ohne Verpflichtung.
          </p>
        </div>
      </section>
    </main>
