  ...
  return (
    <section id="services" className="py-16 sm:py-20 lg:py-24">
      <div className="container-lp">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {serviceGroups.map((group, i) => {
            ...
            return (
              ...
              >
                <SpotlightCard
                  spotlightColor="rgba(91, 140, 255, 0.18)"
                  className="card-soft group flex h-full flex-col p-6 sm:p-7"
                >
                  {/* Gruppen-Kopf */}
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      <span className="text-[11px] font-bold uppercase tracking-[0.14em] text-stamp">
                        {`0${i + 1}`}
                      </span>
                  ...
                  <ul className="mt-6 flex-1 space-y-4">
                    {group.services.map((service) => (
                      <li
                        key={service.title}
                        className="border-l-2 border-stone-100 pl-4 transition-colors group-hover:border-primary/40"
                      >
        ...
        <Reveal delay={120}>
          <p className="mx-auto mt-8 flex max-w-2xl items-center justify-center gap-2.5 rounded-xl border border-stone-200 bg-stone-50/80 px-5 py-3.5 text-center text-sm text-stone-600">
            <span className="grid size-6 shrink-0 place-items-center rounded-full bg-primary/10 text-stamp">
