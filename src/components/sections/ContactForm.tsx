            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-5">
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  ...
                  <Field id="url" label="Website" optional error={errors.url}>
                    <Input
                      id="field-url"
                      value={state.url}
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  <Field
                    id="serviceFocus"
                    label="Welche Leistung möchten Sie hauptsächlich vermarkten?"
                    required
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  ...
                  <Field
                    id="capacity"
                    label="Wie viel zusätzliche Kapazität besteht aktuell?"
                    required
                ...
                <Field
                  id="orderValueRange"
                  label="Ungefährer typischer Auftragswert"
                  optional
                >
                  <select
                    id="field-orderValueRange"
                    value={state.orderValueRange}
                    onChange={(e) => update("orderValueRange", e.target.value)}
                    className="focus-ring h-12 w-full rounded-xl border border-input bg-white px-3 text-sm text-navy"
                  >
                ...
                >
                  {status === "loading" ? (
                    <>
                      <Loader2 className="size-5 animate-spin" /> Wird gesendet
                      …
                    </>
                  ) : (
                    <>
